...
contract MetadataDeployment {
    ...
    function _loadFiles() internal {
        ...
        //read bold file
        bytes memory boldFile = bytes(string("bold"));
        ...
        //read eth file
        bytes memory ethFile = bytes(string("weth"));
        ...
        //read wstETH file
        bytes memory wstethFile = bytes(string("wstETH"));
        ...
        //read rETH file
        bytes memory rethFile = bytes(string("rETH"));
        ...
        bytes memory geistFile = bytes(string("geist"));
