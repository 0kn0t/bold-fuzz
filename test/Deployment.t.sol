...
import "./mocks/BorrowerOperationsTester.t.sol";
import "./mocks/TroveManagerTester.t.sol";
import "./mocks/CollateralRegistryTester.sol";
import "src/TroveNFT.sol";
import "src/NFTMetadata/MetadataNFT.sol";
import "src/CollateralRegistry.sol";
import "./mocks/MockInterestRouter.sol";
import "./mocks/PriceFeedTestnet.sol";
import "./mocks/MetadataDeployment.sol";
...
import {WETHTester} from "./mocks/WETHTester.sol";
...
contract TestDeployer is MetadataDeployment {
    ...
    struct LiquityContractsDev {
        ...
        TroveNFT troveNFT;
        PriceFeedTestnet priceFeed; // Tester
    ...
    struct DeploymentVarsDev {
        ...
        AddressesRegistry[] addressesRegistries;
        ...
        )
    {
        ...
        vars.addressesRegistries = new AddressesRegistry[](vars.numCollaterals);
        vars.troveManagers = new ITroveManager[](vars.numCollaterals);

        // Deploy the first branch with WETH collateral
        vars.collaterals[0] = _WETH;
        (AddressesRegistry addressesRegistry, address troveManagerAddress) =
